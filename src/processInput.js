...
const senders = {}
export async function processInput(message, speaker, agent, res, ignoreContentFilter) {
        ...
        if (!ignoreContentFilter && useProfanityFilter) {
        ...
        if (success) {
                ...
                if (!ignoreContentFilter && useProfanityFilter) {
                        ...
                        filter = shouldFilter;
                        shouldSendOut = ratingSuccess;
                        if (!ignoreContentFilter && filter) {
